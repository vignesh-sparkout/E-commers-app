...
export class ProductService {
  products: Product[] = [
    ...
    },
    {
      ...
      price: 44999,
      description: 'The LG QNED AI QNED80 4K Smart TV (2025) blends LG QNED color technology with the Alpha 7 AI 4K processor to deliver vivid images and lifelike sound for immersive home entertainment.',
      image: '/Images/lg.webp',
      stock: 12,
      rating: 4.4,
      discount: 10,
      images: ['/Images/lg.webp'],
      specifications: [],
      isFeatured: false
    },
    {
